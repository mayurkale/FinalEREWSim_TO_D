...
void Analysing(int index,unsigned int IDcode,long int l_soc, long int l_fracsec,int);
void app2_Analysing(int index,unsigned int IDcode,long int soc, long int fracsec,long int l_soc, long int l_fracsec);
...
void db_cfginsert(struct cfg_frame *); 
unsigned int to_intconvertor1(unsigned char array[]);  //Added by gopal  -- to_intconvertor1
void storeDataInDB(struct data_frame *df);
int insertFreqNDFreq(struct data_frame *temp_df,int j, int lPDCID,int pmuID, unsigned int soc,unsigned int fracsec,int freqBuffIndex,unsigned char format);
int dataCollectInPhasorBuff(char *cmd, char *phasorBuff,int pBuffIndex);
int dataCollectInFreqBuffer(char*,char*,int);
void insertRowsInDB();
/**************************************** End of File *******************************************************/
